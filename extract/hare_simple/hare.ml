...
let hare_tortoise =
  CSeq ((CAssign (('h'::[]), (const_val (Vnat O)))), (CSeq ((CAssign (('t'::[]),
    (const_val (Vnat (S (S (S (S (S O))))))))), (CSeq ((CWhile ((fun s ->
    Nat.ltb (as_nat (s ('h'::[]))) (as_nat (s ('t'::[])))), (CSeq ((incr ('t'::[])), (CUniform
    ((const (S (S (S O)))), (fun n -> CAssign (('h'::[]), (fun s -> Vnat
    (add (as_nat (s ('h'::[]))) (S n))))))))))), (CObserve (fun s ->
    Nat.ltb (S (S (S (S (S (S (S (S (S (S O)))))))))) (as_nat (s ('t'::[]))))))))))
...
(** val biased_tree : tree **)

let biased_tree =
  elim_choices (compile hare_tortoise empty)

(** val unbiased_tree : tree **)
