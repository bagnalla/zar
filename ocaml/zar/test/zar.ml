...
let () = add_test "int_of_positive" @@
           ...
           (check int) "" 20 (int_of_positive @@ Coq_Pos.mul five four)
...
let () = add_test "positive_of_int" @@
           ...
           (check positive) "" (Coq_Pos.mul five five) (positive_of_int 25)
...
let () = add_qcheck @@
           QCheck.(Test.make ~name:"positive_of_int_plus" ~count:1000
                     ...
                     (fun (n, m) -> Coq_Pos.add (positive_of_int n) (positive_of_int m)
                                    = positive_of_int (n + m)))
...
let () = add_qcheck @@
           QCheck.(Test.make ~name:"int_of_positive_plus" ~count:1000
                     ...
                     (fun (n, m) -> int_of_positive n + int_of_positive m
                                    = int_of_positive (Coq_Pos.add n m)))
...
let () = add_qcheck @@
           QCheck.(Test.make ~name:"z_of_int_plus" ~count:1000
                     ...
                     (fun (n, m) -> Z.mul (z_of_int n) (z_of_int m)
                                    = z_of_int (n * m)))
